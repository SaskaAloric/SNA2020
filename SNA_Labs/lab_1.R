...
# visualisation.
write.graph(advice_net, file=paste0(output_dir, 'krack_advice_net.graphml'), format="graphml")
...
write.graph(advice_net, file=paste0(output_dir, 'krack_advice.txt'), format="edgelist")
...
saveRDS(advice_net, paste0(output_dir, "krack_advice.RData"))
saveRDS(friendship_net, paste0(output_dir, "krack_friendship.RData"))
saveRDS(reports_to_net, paste0(output_dir, "krack_reports_to.RData"))
