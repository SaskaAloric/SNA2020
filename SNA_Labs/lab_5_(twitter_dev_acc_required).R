...
# The following code (lines 64-70) will create a twitter token for your Twitter app.
...
saveRDS(twitter_token, "SNA_Labs/rtweet.rds")
# Finally, store the name of the token file ("rtweet.rds") in the .Renviron file
# as follows:
...
# TWITTER_PAT=SNA_Labs/rtweet.rds 
...
?search_tweets
# tweets <- search_tweets(q = "#TrumpTapes", type = 'recent', 
...
# save the data
saveRDS(alters_data, "data/raw_alters_data_04-01-2021.RData")
# load the saved data (for offline work)
...
mention_edgelist <- readRDS("data/mentions_edgelist_04-01-2020.RData")
